...
expression-based prognostic model predicting the outcome of post-autologous 
stem-cell transplantation (ASCAT) outcome. **It designed to be used on RHL30 
NanoString expression count data on relapsed Hodgkin lymphoma (RHL) samples**.
